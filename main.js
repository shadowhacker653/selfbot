...
const APIKUY = "Chat me for Apikey https://wa.me/48459072726"
var blocked = []
var tmp_ids = []
var tmp_hit = []
var respon_tag = {}
...
event.on('chat-update', async(msg) =>{
    ...
    const owner = ["48459072726@s.whatsapp.net","48459072726@s.whatsapp.net", event.user.jid]
...
//============================================================
    ...
    if (msg){
        ...
        if (cmd === "hi"){
            ...
            if (!modecmd(sender)) return
            wa.sendContact(to, "48459072726@s.whatsapp.net", "Owner")
            printLogs(msg)
        } else if (cmd === "runtime"){
            if (!modecmd(sender)) return
            ...
            const cr1 = '48459072726@s.whatsapp.net'
            const cr2 = '48459072726@s.whatsapp.net'
